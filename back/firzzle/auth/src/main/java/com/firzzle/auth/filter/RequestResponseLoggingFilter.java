...
/**
 * @Class Name : RequestResponseLoggingFilter.java
    ...
    protected void doFilterInternal(HttpServletRequest request, HttpServletResponse response, FilterChain filterChain)
        ...
        if ("POST".equals(requestMethod) || "PUT".equals(requestMethod) || "PATCH".equals(requestMethod)) {
            ...
            if (content.length > 0) {
                ...
                logger.info("요청 본문 - [{}] {}: {}", requestMethod, requestUri, contentAsString);
            }
        }
        ...
        if (responseContent.length > 0) {
            ...
            logger.info("응답 본문 - [{}] {}: {}", requestMethod, requestUri, responseContentAsString);
        }
