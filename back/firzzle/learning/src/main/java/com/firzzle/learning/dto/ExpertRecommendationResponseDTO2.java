...
public class ExpertRecommendationResponseDTO2 extends PageResponseDTO<ExpertResponseDTO> {

    @Schema(description = "오리지널 컨텐츠 태그")
    private String originTags;

    @Builder(builderMethodName = "recommendationBuilder")
    public ExpertRecommendationResponseDTO2(List<ExpertResponseDTO> content, Integer p_pageno, Integer p_pagesize, Integer totalElements, String originTags) {
