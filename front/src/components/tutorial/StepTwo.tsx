        ...
        <div className='mb-4 flex items-start'>
          ...
          <div className='w-full'>
            ...
            <div className='mb-4 flex w-full gap-2'>
              <button className='flex-1 rounded-md bg-gray-100 px-6 py-3 font-medium text-gray-700'>
                쉽게 설명해주세요
              </button>
              <button className='flex-1 rounded-md bg-blue-400 px-6 py-3 font-medium text-white'>
                배경지식이 있어요
              </button>
            </div>
            <div className='rounded-lg bg-gray-50 p-6'>
              <div className='mb-4'>
                ...
                <p className='text-gray-700'>
                  ...
                  사진을 학습한 알고리즘이 고양이의 개념 구분하거나, 과거의 거래
                  데이터를 학습해 주가를 예측하는 것처럼, 경험(데이터)를 통해
                  일고리즘이 스스로 성능을 개선해 나가는 것이 머신러닝의
                  핵심입니다.
                </p>
              </div>
            </div>
